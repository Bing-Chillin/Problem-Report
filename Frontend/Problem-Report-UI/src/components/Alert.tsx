...
const Alert: React.FC<AlertProps> = ({ 
  ...
  const progressPercentage = autoClose ? ((timeLeft / autoCloseDelay) * 100) : 100;

  const getAlertClasses = () => {
    const basicClassNames = 'relative p-4 rounded-lg border-l-4 shadow-md transition-all duration-300 ease-in-out overflow-hidden';
